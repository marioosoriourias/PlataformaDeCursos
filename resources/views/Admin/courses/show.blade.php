...
<x-app-layout>
    <section class="bg-gray-700 py-12 mb-12">
        <div class="container grid grid-cols-1 lg:grid-cols-2 gap-6">
            <figure>
                ...
                @else
                    <img class="h-60 w-full object-cover" src="https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="">
                @endif
            </figure>
            ...
            <div class="text-white">
                ...
                <p class="mb-2"><i class="fas fa-chart-line"></i> Nivel: {{$course->level->namem}}</p>
    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        @if (session('info'))
            <div class="lg:col-span-3" x-data="{open: true}" x-show="open">
                <div class="relative py-3 pl-4 pr-10 leading-normal text-red-700 bg-red-100 rounded-lg" role="alert">
                    ...
                    <span class="bock sm:inline">{{session('info')}}</span>
        ...
        <div class="order-2 lg:col-span-2 lg:order-1">
            ...
            <section class="font-bold text-3xl">
                <h1>Descripción</h1>
