...
<x-app-layout>
    ...
    <section class="mt-24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/bee-6075541_640.jpg')}}" alt="">
                </figure>
                ...
                <p class="text-sm text-gray-500">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eum debitis atque modi quod. Non possimus perferendis doloremque qui accusamus sed, cumque.</p>
            </article>

            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/jay-5988657_640.jpg')}}" alt="">
                </figure>
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/lake-5996427_640.jpg')}}" alt="">
                </figure>
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/sunflowers-6007847_640.jpg')}}" alt="">
                </figure>
