<div>
     ...
     @foreach ($section->lessons as $item)
        <article class="card m-4" x-data="{open:false}">  
            <div class="card-body">
                ...
                @if ($lesson->id == $item->id)
                    ...
                    <form wire:submit.prevent="update">
                        <div class="flex items-center">
                            ...
                            <input wire:model="lesson.name" class="form-input  w-full border border-gray-300">
                        </div>
                        ...
                        <div class="flex item-center mt-4">
                            ...
                            <input  wire:model="lesson.url" class="form-input w-full border border-gray-300">
                        </div>
                        ...
                        <div class="mt-4 flex ">
                            <button type="button" class="btn btn-danger justify-end" wire:click="cancel">Cancelar</button>
        ...
        <article class="card" x-show="open">
            <div class="card-body">
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <label class="w-32">Nombre:</label>
                        <input wire:model="name" class="form-input  w-full border border-gray-300">
                    </div>
                    ...
                    <div class="flex item-center mt-4">
                        <label class="w-32">Url:</label>
                        <input  wire:model="url" class="form-input w-full border border-gray-300">
                    </div>
