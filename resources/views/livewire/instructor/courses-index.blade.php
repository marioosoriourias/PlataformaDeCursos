<div class="container py-8">
    ...
    <x-table-responsive>
        ...
        <div class="px-6 py-4 flex">
            ...
            <a class="btn btn-danger ml-2" href="{{route('instructor.courses.create')}}">Agregar nuevo curso</a>
        </div>
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="flex items-center">
                    <div class="flex-shrink-0 h-10 w-10">
                      ...
                      @else
                          <img class="h-10 w-10 rounded-full" src="https://images.pexels.com/photos/4498362/pexels-photo-4498362.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="">
                      @endisset
